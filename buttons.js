                ...
                await user.send({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(`**${interaction.user.displayName}** has closed your ticket since it's marked as completed. Thank you for using our support!`)
                            .setFooter({
