                            ...
                            await sent.edit({
                                ...
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription('Thank you for creating a new ticket, a staff member should respond to your ticket any time soon!')
                                        .setFooter({
                                            text: '© Brussles Airlines Roblox'
                                        })
                                        .setColor('Green')
                                ],
                                components: []
